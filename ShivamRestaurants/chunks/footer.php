<section class="ffooter">
  <footer class="page-footer">
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="grey-text text-lighten-4">Department of Information Technology,
            Mizoram University<br>
            P.O. Box 190 Aizawl 796004</p>
          <p class="grey-text text-lighten-4">Phone : +91 8540064298</p>
        </div>
    ...
    <div class="footer-copyright">
      <div class="container">
        © 2023 Copyright @ Shivam Restaurants
